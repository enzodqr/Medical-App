package com.app.medical.Agenda.Fragments;
...
import com.app.medical.Agenda.CustomCalendarView;
...
public class Calendar_fragment extends Fragment {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            ...
            customCalendarView = getView().findViewById(R.id.custom_calendar_view);
        }
    }
